...
userdb = MySQL(app, prefix="userdb", host=db['mysql_host'], user=db['mysql_user1'], password=db['mysql_password1'],db=db['login_db'])
mysql1 = MySQL(app, prefix="mysql1", host=db['mysql_host'], user=db['mysql_user1'], password=db['mysql_password1'],db=db['mysql_db']) 
mysql2 = MySQL(app, prefix="mysql2", host=db['mysql_host'], user=db['mysql_user2'], password=db['mysql_password2'],db=db['mysql_db'])
